{// Cucharadas de visores:
  // El "alcance" de una variable indica dónde está disponible en el código, ya sea globalmente o localmente dentro de una función o bloque de código delimitado por llaves {}.
